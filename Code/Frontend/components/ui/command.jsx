...
function CommandItem({ className, ...props }) {
  return (
    <CommandPrimitive.Item
      className={cn(
        "cursor-pointer relative flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-medium outline-none select-none transition-all duration-200 text-slate-200 hover:bg-gradient-to-r hover:from-indigo-600 hover:to-indigo-500 hover:text-white hover:translate-x-1.5 hover:shadow-md hover:shadow-indigo-500/20 data-[selected=true]:bg-gradient-to-r data-[selected=true]:from-indigo-600 data-[selected=true]:to-indigo-500 data-[selected=true]:text-white data-[selected=true]:translate-x-1.5 data-[selected=true]:shadow-md data-[selected=true]:shadow-indigo-500/20 data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 my-0.5",
        className
      )}
      {...props} />);
