  ...
  if (!order) {
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center gap-4">
        <p className="text-2xl font-semibold text-slate-700">Order Not Found</p>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-slate-500">{order.supplierContact}</p>
            <p className="text-sm text-slate-500">{order.supplierEmail}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
